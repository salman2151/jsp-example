...
<%@ page import="com.bloggingapp.contant.Constants"%>
...
<body>
	...
	<div
		style="display: flex; height: 87.5%; margin: 10px; background: white; border-radius: 10px; padding: 10px">
		<div class="btn-group"
			style="width: 20%; background: #F0F0F0; padding: 15px; border-radius: 10px;">
			<button id="btn-categories"
				onclick="location.href = 'GetAllCategoriesServlet'">CRUD
				Categories</button>
		...
		<div class="btn-group" style="width: 80%; padding: 10px">
			...
			<div id="blogs-div" style="width: 100%; height: 100%">
				...
				<h3 style="text-align: center; padding-top: 10px">Recent 3
					Blogs</h3>
